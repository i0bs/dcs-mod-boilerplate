...
heading = {valmin = 0, valmax = math.rad(360), T1 = 0.19, T2 = 0.2, bias = {{valmin = 0, valmax = math.rad(360.0), bias = math.rad(1)}}}
...
DEFECTIVE_MECHANISM     = 1

Damage = {
	{Failure = DEFECTIVE_INSTRUMENT, Failure_name = "DEFECTIVE_INSTRUMENT", Failure_editor_name = _("Directional gyro fail"),  Element = 3, Integrity_Treshold = 0.3, work_time_to_fail_probability = 0.5, work_time_to_fail = 3600*300},
	{Failure = DEFECTIVE_MECHANISM, Failure_name = "DEFECTIVE_MECHANISM", Failure_editor_name = _("Directional gyro mechanism fail"),  Element = 3, Integrity_Treshold = 0.3, work_time_to_fail_probability = 0.5, work_time_to_fail = 3600*300},
}
